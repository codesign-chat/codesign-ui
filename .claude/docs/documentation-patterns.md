# Codesign UI - Documentation Patterns

This guide covers patterns for writing component documentation in the Codesign UI website.
...
Add projects/design systems built with Codesign UI to `website/src/content/showcases.json`:
