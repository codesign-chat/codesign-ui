# Codesign UI - Development Guide

This guide covers development workflows, commands, and processes for working with the Codesign UI codebase.
...
The Codesign UI documentation website is built with Next.js and uses several key patterns for content management and
...
with permission to publish the `@codesign-ui/*` packages.
