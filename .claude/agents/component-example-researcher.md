...
- Review the current Codesign UI implementation across all frameworks
...
- Ensure examples align with Codesign UI's headless philosophy
...
- **Implementation Notes**: Any special considerations for Codesign UI
...
- GitHub CLI (gh) for searching issues and discussions in:
  ...
  - radix-ui/primitives
  - shadcn/ui
  - codesign-chat/codesign-ui (for existing Codesign UI feedback)
...
- Respect Codesign UI's TypeScript-first, no-comments coding style
...
- If you find conflicting patterns between Codesign and Zag implementations
