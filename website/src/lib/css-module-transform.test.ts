...
describe('stripCss', () => {
  test('strips single css module import', () => {
    const code = `import { Component } from '@codesign-ui/react'
...
export const Example = () => <Component className={styles.Root} />`
    ...
    expect(result).toBe(`import { Component } from '@codesign-ui/react'

export const Example = () => <Component />`)
  })

  test('strips multiple css module imports', () => {
    const code = `import { Clipboard } from '@codesign-ui/react/clipboard'
...
export const Context = () => {
  return (
    ...
    expect(result).toBe(`import { Clipboard } from '@codesign-ui/react/clipboard'
import { CheckIcon } from 'lucide-react'
