'use client'
import type { Assign } from '@codesign-ui/react'
import { RadioGroup } from '@codesign-ui/react/radio-group'
...
export const Label = withContext<HTMLSpanElement, Assign<HTMLStyledProps<'span'>, RadioGroup.LabelBaseProps>>(
  RadioGroup.Label,
  'label',
)
