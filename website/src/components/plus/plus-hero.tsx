          ...
          <Stack gap={{ base: '5', md: '6' }}>
            <Stack gap={{ base: '3', md: '4' }}>
              ...
              <Heading as="h1" fontWeight="bold" textStyle={{ base: '4xl', md: '6xl' }}>
                ...
                <styled.span color="colorPalette.default">Codesign Plus</styled.span>
              </Heading>
            </Stack>
            <Text textStyle={{ base: 'lg', md: 'xl' }} color="fg.muted">
              Accelerate your usage of Codesign UI with exclusive examples designed to build production-ready components
              faster.
            </Text>
          </Stack>
