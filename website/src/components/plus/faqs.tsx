...
export const Faqs = () => {
  const questions = [
    {
      question: 'What do I get when I purchase Codesign Plus?',
      answer: (
        <Text>
    ...
    {
      question: 'Which version of Codesign UI do I need?',
      answer: <Text>The examples here use the latest version of Codesign UI.</Text>,
    },
    {
      ...
      answer: (
        <Text>
          ...
          <Link
            href="https://github.com/codesign-chat/codesign-ui/issues/new?assignees=&labels=&projects=&template=bug_report.yml"
            target="_blank"
      ...
      <Stack gap={{ base: '12', lg: '24' }} direction={{ base: 'column', lg: 'row' }} width="full">
        <Stack gap={{ base: '4', md: '5' }} maxW={{ lg: 'md' }}>
          ...
          <Text color="fg.muted" textStyle="lg">
            Everything you need to know about Codesign Plus. For questions about licensing, please see our{' '}
            <Link asChild>
