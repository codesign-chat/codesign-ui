...
const licenses = {
  personal: {
    ...
    features: [
      ...
      },
      {
        ...
        description: ' — Help us maintain and enhance Codesign UI with quality examples and components.',
  ...
  team: {
    ...
    originalPrice: '$649',
    checkoutUrl:
      'https://chakra-pro.lemonsqueezy.com/buy/32116f45-7b47-40b6-9fb7-a5f0d9a72d51?discount=0&enabled=399172',
    features: [
      {
