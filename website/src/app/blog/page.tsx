      ...
      <Container py={{ base: '16', md: '24' }} maxW="5xl" flex="1">
        <Stack>
          ...
          <Text size="lg" color="fg.muted">
            This blog is the official source for the updates from the Codesign UI team
          </Text>
        </Stack>
...
export const metadata = {
  title: 'Blog',
  description: 'This blog is the official source for the updates from the Codesign UI team',
}
