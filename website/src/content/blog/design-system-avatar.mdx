...
[Codesign UI's](https://codesign.chat/docs/components/avatar) Avatar is a fully functional, unstyled component that comes with
...
Recipes are a built-in concept in Panda CSS and they integrate nicely with Codesign UI components. To organize styles cleanly
...
Codesign UI gives you the building blocks, but how you style those blocks is entirely up to you. Whether you're using Vanilla
