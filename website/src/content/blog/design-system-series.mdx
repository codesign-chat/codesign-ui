...
description: How to build a Design System with Codesign UI
date: '2025-06-02'
author: 'Esther'
tags: ['design-system', 'styling', 'react', 'javascript']
---

## Building a Design System with Codesign UI
...
> **That's where Codesign UI comes in handy!**

Codesign UI is a headless, accessible component library that provides unstyled UI primitives like modals, avatars,
accordions, and more. Since Codesign UI ships without predefined styles, it gives you complete freedom to implement your
own design system, exactly how you want it.

In this design system series, we'll explore how to style Codesign UI components using two different approaches:

- **Vanilla CSS**: This approach allows you to design your components with CSS using Codesign UI anatomy.

- **[Panda CSS](https://panda-css.com/)**: This approach uses a zero runtime styling engine built pair nicely with
  Codesign UI. We'll look at how to use **recipes** and **design tokens** to create scalable styles.

## Prerequisites

To get started in this series, you'll need the following:

- [Codesign UI](https://codesign.chat/docs/overview/getting-started)
- [Panda CSS](https://panda-css.com/docs/installation/postcss) (optional)
- [Storybook](https://storybook.js.org/docs)

Throughout this series, you'll learn how to build a design system with Codesign UI components and styling them with
Vanilla CSS or Panda CSS.
