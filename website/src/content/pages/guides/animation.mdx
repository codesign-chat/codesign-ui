...
phases with CSS. The latter is achievable because Codesign UI Components postpones the unmounting while your animation runs.
...
One significant advantage of using Codesign UI Elements is the control you have over the unmounting phase of your components.
