...
description: Working with tree collections in Codesign UI
---
...
```ts
import { createTreeCollection } from '@codesign-ui/react/collection'
...
```ts
import { createFileTreeCollection } from '@codesign-ui/react/collection'
