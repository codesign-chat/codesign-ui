...
```tsx
import { Avatar, useAvatarContext } from '@codesign-ui/react/avatar'
import { getImageProps, type ImageProps } from 'next/image'

const AvatarNextImage = (props: ImageProps) => {
  const avatar = useAvatarContext()

  const { hidden, ...codesignImageProps } = avatar.getImageProps()
...
> Refer to this [Github Discussion](https://github.com/codesign-chat/codesign-ui/discussions/3147) for more information.
