...
The Codesign UI MCP Server is a specialized [Model Context Protocol](https://modelcontextprotocol.io/introduction) server
that empowers AI agents to build design system components with full knowledge of Codesign UI.

<img src="/images/codesign-mcp.png" alt="Codesign UI MCP Server" width="100%" height="420px" style={{ borderRadius: '10px' }} />
