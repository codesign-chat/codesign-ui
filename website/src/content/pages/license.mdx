...
- **Examples:** The React, Svelte, Solid and Vue source code snippets provided to the Licensee upon purchasing Codesign Plus.
...
Violation of this license may result in the termination of your Codesign Plus account, with refunds issued at the creators'
...
Please try the [free Examples](/react/examples) before purchasing Codesign Plus to familiarize yourself with the product.
