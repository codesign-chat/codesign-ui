...
The creators of Codesign Plus grant an ongoing, non-exclusive license to use the Examples to **one individual** (the
Licensee).
...
- Publishing a repository of Codesign Plus Examples or derivative works publicly.
- Replicating Codesign Plus and offering it for sale or free.
...
- **Examples:** The React, Solid and Vue source code snippets provided to the Licensee upon purchasing Codesign Plus.
...
The creators of Codesign Plus grant an ongoing, non-exclusive license to use the Examples to all **Employees and
...
- Publishing a repository containing Codesign Plus Examples or derivative works publicly.
- Replicating Codesign Plus and distributing it for sale or free.
...
- **Examples:** The React, Svelte, Solid and Vue source code snippets provided to the Licensee upon purchasing Codesign
  Plus.
...
Violation of this license may result in the termination of your Codesign Plus account, with refunds issued at the
creators' discretion. In cases of blatant or malicious violations, such as redistributing the Examples through
unauthorized channels, no refund will be provided.

The creators of Codesign Plus retain all rights to the Examples, except for the permissions explicitly granted in this
...
Please try the [free Examples](/react/examples) before purchasing Codesign Plus to familiarize yourself with the
product.
