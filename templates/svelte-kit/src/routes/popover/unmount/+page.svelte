...
<section>
  <div class="row">
    <button class="btn" onclick={toggleArkVisibility}>Toggle Codesign visibility</button>
  </div>

  {#if visible}
    <div class="block">
      <h3>Codesign UI Popover</h3>

      <Popover.Root>
        <Popover.Trigger class="trigger">Open Codesign UI Popover</Popover.Trigger>
        <Popover.Positioner>
