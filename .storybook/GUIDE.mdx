...
This guide documents the patterns for styling Codesign UI component examples using CSS modules across all supported
...
:root {
  /* Neutral colors */
  --demo-neutral-fg: #1a1a19;
  --demo-neutral-subtle: #f5f5f4;
  --demo-neutral-emphasized: #70706b;

  /* Coral accent */
  --demo-coral-solid: #ec5d5e;
  --demo-coral-fg: #c63637;
  --demo-coral-subtle: #feebec;

  /* Borders */
  --demo-border-emphasized: #e4e4e3;
...
Each component module exports classes matching Codesign UI part names:
...
Codesign UI components expose data attributes for state-based styling:
