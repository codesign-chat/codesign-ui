<script lang="ts">
  import { useFocusVisible } from '@codesign-ui/svelte/interaction'
...
<div class="container">
  <p class="status">Focus visible: {String(isFocusVisible())}</p>
  <div class="field">
