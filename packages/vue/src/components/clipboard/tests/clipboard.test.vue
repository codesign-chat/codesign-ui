...
import { Clipboard, type ClipboardRootEmits, type ClipboardRootProps } from '@codesign-ui/vue/clipboard'
...
<template>
  <Clipboard.Root default-value="https.//codesign.chat" v-bind="localProps">
