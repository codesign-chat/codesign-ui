...
import { SegmentGroup } from '@codesign-ui/vue/segment-group'
import { ref } from 'vue'
...
<template>
  <div class="stack">
    <button :class="button.Root" @click="show = !show">
      {{ show ? 'Hide' : 'Show' }}
    </button>
    <SegmentGroup.Root v-if="show" :class="styles.Root" default-value="React">
