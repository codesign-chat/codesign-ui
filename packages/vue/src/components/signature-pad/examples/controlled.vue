...
import { SignaturePad } from '@codesign-ui/vue/signature-pad'
...
<template>
  <div class="stack">
    ...
    <SignaturePad.Root :class="styles.Root" v-model:paths="paths">
    ...
    <button :class="button.Root" @click="paths = []">Clear</button>
  </div>
</template>
