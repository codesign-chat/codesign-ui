import { Collapsible } from '@codesign-ui/solid/collapsible'
    ...
    <Collapsible.Content class={styles.Content}>
      <div class={styles.Body}>
        ...
        <p>
          ...
          giving you complete control over styling. Each component follows WAI-ARIA patterns for accessibility out of
          the box.
        </p>
        <p>
          Whether you're building a design system from scratch or need reliable primitives for your next project,
          Codesign UI provides the foundation you need without imposing any visual constraints.
        </p>
      </div>
    </Collapsible.Content>
  </Collapsible.Root>
