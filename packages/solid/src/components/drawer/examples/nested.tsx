import { Drawer, useDrawer } from '@codesign-ui/solid/drawer'
...
export const Nested = () => {
  ...
  return (
    <div class={styles.main}>
      <button class={styles.button} onClick={() => first().setOpen(true)}>
        Open drawer stack
      </button>
              ...
              <div class={styles.content}>
                ...
                <div class={styles.actions}>
                  <div class={styles.actionsLeft}>
                    <button class={styles.ghostButton} onClick={() => second().setOpen(true)}>
                      Security settings
                    </button>
                  </div>
          ...
          <Drawer.Content class={styles.contentHost}>
            <div class={styles.popup}>
              ...
              <div class={styles.content}>
                ...
                <div class={styles.actions}>
                  <div class={styles.actionsLeft}>
                    <button class={styles.ghostButton} onClick={() => third().setOpen(true)}>
                      Advanced options
                    </button>
                  </div>
                  <Drawer.CloseTrigger class={styles.button}>Close</Drawer.CloseTrigger>
