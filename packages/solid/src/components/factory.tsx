...
type JsxElements = {
  [E in ElementType]: CodesignComponent<E>
}
...
type CodesignComponent<E extends ElementType> = (props: HTMLArkProps<E>) => JSX.Element

const withAsProp = <T extends ElementType>(Component: T) => {
  const CodesignComponent: CodesignComponent<T> = (props) => {
