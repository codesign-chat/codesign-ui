...
export const getComponentPropsTool: Tool<{ componentList: string[] }> = {
  ...
  description:
    'Get the props/properties for a specific Codesign UI component in a given framework. This tool retrieves detailed information about the available props for the specified component.',
  ctx: async () => {
