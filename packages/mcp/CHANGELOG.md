...
- Added `get_component_props` tool to retrieve component props/properties for specific Codesign UI components
...
- Initial release of the official MCP server for Codesign UI
